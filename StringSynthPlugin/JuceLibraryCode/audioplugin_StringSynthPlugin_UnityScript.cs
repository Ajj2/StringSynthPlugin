...
public class audioplugin_StringSynthPluginGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_StringSynthPlugin"; } }
    public override string Description    { get { return "StringSynthPlugin"; } }
    public override string Vendor         { get { return "Ajj"; } }

    //==============================================================================
	[DllImport("audioplugin_StringSynthPlugin")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_StringSynthPlugin")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_StringSynthPlugin")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_StringSynthPlugin")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_StringSynthPlugin")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_StringSynthPlugin")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_StringSynthPlugin")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
